...
License  : Apache-2.0
Requires: mvn-maven-plugin-testing-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-maven-plugin-testing package.
Group: Data

%description data
data components for the mvn-maven-plugin-testing package.
...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/plugin-testing/maven-plugin-testing-harness/1.3
